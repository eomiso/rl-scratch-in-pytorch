...
# The reward_scale is how we are going to account for the entropy
# in the framework.
class Agent():
    def __init__(self,
                 alphai=0.0003,
                 ...
                 reward_scale=2):
        self.gamma = gamma
        self.tau = tau  # soft update on the target network
